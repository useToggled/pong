    ...
    <main className='grid lg:grid-cols-[1fr,45vw]'>
      ...
      <div className='flex flex-col items-center justify-between gap-6 p-8 lg:items-start lg:justify-center'>
        ...
        <div className='flex max-w-xs flex-col gap-4 font-twitter-chirp-extended lg:max-w-none lg:gap-16'>
          <h1
            className='text-3xl before:content-["Explore_the_world_from_your_phone."] 
                       lg:text-6xl lg:before:content-["Explore_now"]'
          />
        ...
        <div className='flex max-w-xs flex-col gap-6 [&_button]:py-2'>
          <div className='grid gap-3 font-bold'>
            ...
            >
              ...
              <a
                href='https://legal.zymono.com/terms'
                target='_blank'
                rel='noreferrer'
              >
                Terms of Service
              ...
              and{' '}
              <a
                href='https://legal.zymono.com/privacy'
                target='_blank'
                rel='noreferrer'
              >
                Privacy Policy
              ...
              , including{' '}
              <a
                href='https://legal.zymono.com/cookies'
                target='_blank'
                rel='noreferrer'
              >
                Cookie Use
