    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='flex flex-col gap-3 text-center'>
        ...
        <p className='text-light-secondary dark:text-dark-secondary'>
          These settings affect all the Pong accounts on this browser.
        </p>
      </div>
      <article
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/twitter-avatar.png' alt='Pong' />
          <div>
            <div className='flex gap-1'>
              <UserName verified name='Pong' />
              <p className='text-light-secondary dark:text-dark-secondary'>
                @pong
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
              At the heart of Pong are short messages called pongs — just
              like this one — which can include photos, videos, links, text,
              hashtags, and mentions like{' '}
              <span className='text-main-accent'>@pong</span>.
            </p>
          </div>
        </div>
      </article>
